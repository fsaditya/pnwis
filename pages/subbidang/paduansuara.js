...
import Padus from '../../components/question/paduansuara';
...
export default function HorizontalLinearStepper() {
  ...
  function getStepContent(step) {
    switch (step) {
      ...
      case 1:
        return <Padus handleInput={handleInput} data={form} />;
      case 2:
        return (
          <CV
  ...
  return (
    <>
      <Head>
        <title>Subbidang Paduan Suara</title>
      </Head>
      {/* <Close /> */}
      <Container>
        {isDone ? (
