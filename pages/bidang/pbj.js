...
import PBJ from '../../components/question/pbj';
...
export default function HorizontalLinearStepper() {
  ...
  function getStepContent(step) {
    switch (step) {
      ...
      case 1:
        return <PBJ handleInput={handleInput} data={form} />;
      case 2:
        return (
          <CV
  ...
  return (
    <>
      <Head>
        <title>Bidang Pengadaan Barang dan Jasa</title>
      </Head>
      {/* <Close /> */}
      <Container>
        {isDone ? (
